...
public final class PinpointLocalizer implements Localizer {
    ...
    public static class Params {
        public double parYTicks = 1343.6076558601226; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -705.7816843837119; // x position of the perpendicular encoder (in tick units)
    }
